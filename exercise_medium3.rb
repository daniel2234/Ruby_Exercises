...
#   # assigned here and called after in memory
...
#     #its still the same here through the loop
...
#     #assigned here in different variables
...
def tricky_method(a_string_param, an_array_param)
  #this creates a new string object, the reference to this new object is placed in the internal variable of the method
  #and the method considers this new string object to be the one string
  #it has forgotten about one that was passed in now.
  # the old paramstring is still considered is still remembered by the caller of the method, but the method itself forgotten all about it.
  a_string_param += "rutabaga"
  #this appends a new item to an existing array
...
# => this will output pumpkins
puts "My array looks like this now: #{my_array}"
# => this will output [pumpkins],[rutabaga]
...
def tricky_method_two(a_string_param, an_array_param)
  ...
  #gsub replace if the string is pumpkins
