...
p greeting
# this produces a nil and the greeting variable has not been initialized
...
# it mutates the hash value to this {:a=>"hi there"}
...
# puts "one is: #{one}"
# #its going to put one is one
# puts "two is: #{two}"
# #its going to put two is two
# puts "three is: #{three}"
# #its going to put three is three
...
# be created by the same system. That is, without any form of synchronization, 
...
p dot_separated_ip_address?("4.5.5.4")
