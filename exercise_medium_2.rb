...
# total_sum = 0;
# munsters.each {|key, value| puts total_sum += value["age"] if value['gender'] == 'male'}
...
# A quick glance at the docs for the Ruby String class will 
# have you scratching your head over the absence of any "word iterator" methods.
...
# A common idiom used to solve this conundrum is to use the String"#split in conjunction with Array#join methods to 
...
#it added 42 to the hash age and replaced all the hash values in gender to other


#Question 7 
#Method calls can take expressions as arguments. Suppose we define function called rps as follows,
# which follows the classic rules of rock-scissors- paper game, 
# but with a slight twist that it decalres whatever hand ws used in the tie
...
p foo #=> outputs yes but because the function returns yes, yes is passed into the function.
p bar(foo) # => outputs no
